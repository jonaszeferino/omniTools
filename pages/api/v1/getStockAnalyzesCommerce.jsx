...
export default async function handler(req, res) {
  ...
  try {
    const query = "SELECT DISTINCT viewName, clientIdCommerce, DATE_FORMAT(CreatedDate, '%Y-%m-%d %H:%i') as createdDate FROM stock_channel_commerce ORDER BY createdDate DESC LIMIT 30;"
